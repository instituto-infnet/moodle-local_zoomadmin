...
$string['error_curl'] = 'Error requesting Zoom API: {$a}.';
...
$string['error_recordings_replace_url_in_page'] = 'Error replacing link in page.';
$string['error_updating_recordpages_table'] = 'Error updating `local_zoomadmin_recordpages` table. Row ID = {$a}';
$string['execute_time'] = 'Time to execute';
...
$string['file_type_TIMELINE'] = 'Timeline';
$string['file_type_TRANSCRIPT'] = 'Audio transcript';
$string['get_log'] = 'Get log';
$string['google_drive_upload_success'] = 'File successfully uploaded to Google Drive';
$string['google_drive_upload_error'] = 'Error uploading file to Google Drive';
$string['host'] = 'Host';
$string['id'] = 'ID';
$string['last_login_time'] = 'Last login';
$string['log'] = 'Log';
$string['manage'] = 'Zoom settings';
...
$string['oauth2callback'] = 'OAuth 2 token for Google API';
...
$string['recordings_url_replaced_in_page'] = 'Link replaced in page successfully. <a href="{$a}">Click here to open page.</a>';
$string['report_no_data'] = 'No data to show.';
$string['report_no_permission'] = 'You don\'t have permission to see the data from this report.';
$string['schedule_execution'] = 'Schedule execution';
$string['security'] = 'Security';
$string['send_recordings_task_created'] = 'Sending to Google Drive scheduled for {$a}.';
$string['send_recording_to_google_drive'] = 'Send to Google Drive';
$string['send_recordings_to_google_drive'] = 'Send cloud recordings to Google Drive';
$string['send_course_recordings_to_google_drive'] = 'Send course cloud recordings to Google Drive';
$string['size'] = 'Size';
$string['start_time'] = 'Start time';
$string['status'] = 'Status';
$string['token_code_instructions'] = 'The Google API access token has expirted. Please, open the following link and fill in the field below with the authentication code provided, so that a new token can be generated.';
$string['token_code_label'] = 'Verification code:';
$string['type'] = 'Type';
