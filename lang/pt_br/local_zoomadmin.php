...
$string['error_curl'] = 'Erro na requisição à API do Zoom: {$a}.';
...
$string['error_recordings_replace_url_in_page'] = 'Erro ao substituir link na página.';
$string['error_updating_recordpages_table'] = 'Erro ao atualizar tabela `local_zoomadmin_recordpages`. ID do registro = {$a}';
$string['execute_time'] = 'Horário a ser executado';
$string['file_type'] = 'Tipo';
$string['file_type_'] = 'N/D';
$string['file_type_CHAT'] = 'Chat';
$string['file_type_M4A'] = 'Áudio';
$string['file_type_MP4'] = 'Vídeo';
$string['file_type_TIMELINE'] = 'Linha do tempo';
$string['file_type_TRANSCRIPT'] = 'Transcrição do áudio';
$string['get_log'] = 'Obter log';
$string['google_drive_upload_success'] = 'Arquivo enviado ao Google Drive com sucesso';
$string['google_drive_upload_error'] = 'Erro ao enviar arquivo ao Google Drive';
...
$string['oauth2callback'] = 'Autenticação de acesso à API do Google';
...
$string['participants'] = 'Lista de presença';
$string['participants_all_instances'] = 'Lista de presença (todas as sessões)';
...
$string['recordings_url_replaced_in_page'] = 'Link substituído na página com sucesso. <a href="{$a}">Clique aqui para abrir a página.</a>';
$string['report_no_data'] = 'Sem dados para exibir.';
$string['report_no_permission'] = 'Você não possui permissão para ver os dados deste relatório.';
$string['schedule_execution'] = 'Agendar execução';
$string['security'] = 'Segurança';
$string['send_recordings_task_created'] = 'Envio ao Google Drive da reunião número {$a->zoommeetingnumber}, com ID de página {$a->pagecmid} agendado para {$a->exectime}.';
$string['send_recording_to_google_drive'] = 'Enviar ao Google Drive';
$string['send_recordings_to_google_drive'] = 'Enviar gravações para o Google Drive';
$string['send_course_recordings_to_google_drive'] = 'Enviar gravações do curso para o Google Drive';
$string['size'] = 'Tamanho';
$string['start_time'] = 'Início';
$string['status'] = 'Situação';
$string['token_code_instructions'] = 'O token de acesso à API do Google expirou. Por favor, acesse o link a seguir e preencha o campo abaixo com o código de verificação informado, para que um novo token seja gerado.';
$string['token_code_label'] = 'Código de verificação:';
$string['token_created'] = 'Token criado com sucesso.';
$string['type'] = 'Tipo';
