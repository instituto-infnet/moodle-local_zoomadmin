...
$params = array('verification_code' => optional_param('code', null, PARAM_TEXT));

$url = new moodle_url('/local/zoomadmin/oauth2callback.php', $params);
$PAGE->set_url($url);
$context = context_system::instance();
$PAGE->set_context($context);

$title = get_string('pluginname', 'local_zoomadmin') . ' - ' . get_string('oauth2callback', 'local_zoomadmin');
...
echo $page->oauth2callback($params['verification_code']);
