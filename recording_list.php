...
$url = new moodle_url('/local/zoomadmin/recording_list.php', $params);
$PAGE->set_url($url);
$context = context_system::instance();
$PAGE->set_context($context);

$title = get_string('pluginname', 'local_zoomadmin') . ' - ' . get_string('command_recording_list', 'local_zoomadmin');
$PAGE->set_title($title);
$PAGE->set_pagelayout('admin');

require_login();
admin_externalpage_setup('local_zoomadmin_recording_list');
