...
/**
 * Página com relatório de participantes de todas as sessões de uma
 * mesma reunião recorrente.
 *
...
$params = array(
    'meetingnumber' => required_param('meetingnumber', PARAM_TEXT)
);

$url = new moodle_url('/local/zoomadmin/participants_all_instances.php', $params);
$title = 'Lista de presença Live';
